Public Class AddNewLibrary
    '------------------------------------------------------------
    '-                File Name : AddNewLibrary.vb              -
    '-                Part of Project: AddNewLibrary            -
    '------------------------------------------------------------
    ...
    '- File Purpose:                                            -
    '-                                                          -
    '- This file contains the code for the AddNewLibrary form.  -
    '------------------------------------------------------------
    '- Program Purpose:                                         -
    '-                                                          -
    ...
    ' Global newLibrary
    Public Shared newLibrary As New Library
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If IsNumeric(txtIdentifier.Text) Then
        ...
        If LibraryManagerHome.lstLibraries.Exists(Function(l) l.Key = txtIdentifier.Text.ToUpper) Then
            Me.ErrorProvider1.SetError(txtIdentifier, "Identifier already exists")
            Return
        End If
